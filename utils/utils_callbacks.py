...
from utils.metrics import get_f1,get_acc


class CallBackEvaluation(object):
    def __init__(self,test_dataloader_no_flip, test_dataloader_flip, subset='valid', sel_index=None):
...
class CallBackLogging(object):
    ...
    def __call__(self, global_step, loss, acc, f1, epoch, opt):
